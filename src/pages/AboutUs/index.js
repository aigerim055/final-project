        ...
        <div className={'container'}>
            <div className={'about-me'}>
                ...
                <div className={'row align-items-center'}>
                    <div className={'col-6'}>
                        <div className="box me-5">
                            <img src={AboutMeImg} alt="about-us" style={{width: 530}} />
                        </div>
                    </div>
                    <div className="col-6">
                        <div className="box">
                            ...
                            <p>
                                С этого момента у меня в голове засела идея испечь такие же пирожные для себя.
                                Осенью 2020 года я купила пару онлайн-курсов о макарон, чтобы понять, как их готовить.
                                У меня все получилось, и я запустила первую партию в производство. Я люблю, чтобы все
                                было больших размеров, поэтому наши макарон были в несколько раз больше стандартных.
                            </p>
                        </div>
                    </div>
                </div>
                <div className={'row align-items-center'}>
                    <div className={'col-6'}>
                        <div className="box">
                            ...
                            <p>
                                В 2022 году мы начали развивать партнерскую сеть. Нам стали писать кофейни,
                                просили поставлять им пирожные. Мы выбирали те, что подходили нам по всем параметрам:
                                сервис, свежесть продуктов, отзывы посетителей. Например,
                                мы сотрудничаем с «Додо Пицца» в Бишкеке. Летом даже начали поставлять изделия на
                                Иссык-Куль в замороженном виде. Люди советуют друг другу попробовать отечественный бренд.
                            </p>
                        </div>
                    </div>
                    <div className="col-6">
                ...
                <div className={'row align-items-center'}>
                    <div className={'col-6'}>
                        <div className="box me-5">
                            <img src={AboutProjectImg} alt="about-us" style={{width: 530}} />
                        </div>
                    </div>
                    <div className="col-6">
                        <div className="box">
                            ...
                            <p>
                                Перед нами стоит задача — систематизировать весь процесс. Теперь у нас есть своя
                                кофейня и в ней представлен широкий выбор по кухне и бару
                            </p>
                        </div>
                    </div>
                </div>
